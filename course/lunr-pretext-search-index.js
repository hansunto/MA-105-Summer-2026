...
var ptx_lunr_docs = [
{
  ...
  "type": "Section",
  "number": "",
  "title": "MA-150-CDU: Statistics I",
  "body": " MA-150-CDU: Statistics I   Worcester State University, Early College Program, Spring 2026     Course Information     Instructor  Dr. Jason A. Hardin, Professor of Mathematics, jhardin@worcester.edu .    Meeting Information  Mondays and Wednesdays, 7:30am - 8:45am, Zoom    Prerequisite  WSU Mathematics Placement Exam Code 4 or higher      Responsibility for Learning  Every student is responsible for their own learning. The instructor will make every effort to support you; however, if you need any help it is your responsibility to reach out with questions    Course Content  In this course, you will learn the fundamentals of statistics and how to apply them to problems across a variety of disciplines. We will discuss the visual representation of data and develop quantitative tools, using theory and statistical software, to make inferences based on data. Topics will include descriptive measures, probability concepts, the normal distribution, the sampling distribution of the sample mean, confidence intervals for one population mean, hypothesis tests for one population mean and two population means, and descriptive methods of regression and correlation.    Required Materials  A calculator is required for this course. There is no required textbook; notes will be provided in class and other materials will be freely available on the MyOpenMath platform.    Calculators  A scientific, non-graphing calculator capable of computing logarithmic and trigonometric values is required, though its use will be limited to only a handful of sections. I recommend the TI-30X IIS, which you can usually find for around \\$15. You will be asked to complete most quiz\/exam questions without use of a calculator. Graphing calculators, phones, and tablets are never allowed!    MyOpenMath  MyOpenMath (MOM) is a free, open source, online course management system designed for mathematics which we will use extensively in this course. It is available at https:\/\/www.myopenmath.com\/ . You will need to create an account and register for our course on MyOpenMath to get started; we will do this as a group during the first class meeting. All course documents and materials will be posted on MyOpenMath; and all homework will be completed through MyOpenMath.      Assignments and Grading   Homework  Practice is a primary component of the mathematical learning process. For this reason, homework sets will be assigned on MyOpenMath after most class meetings. Assignments will always be due on Sundays by 11:59pm. This means you will often have two homework sets due on Sunday, one which opened on the previous Monday and the other which opened on the previous Wednesday. While the number of problems in each homework set will vary, your score will be considered as a percentage and each set will be weighted equally when computing your homework grade. The problems on the homework sets are sometimes meant to deepen or extend the understanding you have gained from the class lecture and discussion; you should expect to find some of the exercises difficult.  The online homework is set up so you can try most problems two times, then the correct answer will be shown (there may be some questions in which you have only one try, this will be indicated in the homework set). If you miss a problem and want to improve your score, you can click the ``Try a similar problem'' link, which will give you a new question of the same type. You can keep on working on versions of a question until you get it correct. You must earn at least 50% on an assignment for your score to count towards your grade; any set in which you earn less than 50% will be counted as a 0. Assignments will remain available in \"Practice\" mode after their due date to provide additional practice of concepts; new versions of problems can be generated and answered, but scores will not be saved. Be aware, opening an online homework assignment in \"Practice\" mode will disqualify you from being able to redeem a LatePass on that assignment! If you are having trouble on a problem, you may use the \"Message Instructor\" link, which will allow you to send me a message through MyOpenMath; the specific problem you are working on will be automatically included in the message. I can then reply to the message with some guidance. These messages are internal to MyOpenMath and not email, so my reply will go to your messages when you login to MyOpenMath. I will check my messages on MyOpenMath at least once per day. Some problems may have a link to a video solution of a similar problem.  To account for any unexpected emergencies or technical issues that may occur, we will utilize the LatePass feature in MyOpenMath. A LatePass can be redeemed for an automatic 48-hour extension on any online homework set which has NOT been viewed in \"Practice\" mode. To use a LatePass, click the \"Use LatePass\" button next to the appropriate assignment on MyOpenMath and the platform will automatically extend the due date for that assignment to 48 hours after the original due date. Each student will be given 8 LatePasses to use as they wish throughout the semester. Note a maximum of two LatePasses can be used on any single assignment. If circumstances require a more substantial extension, contact your instructor as soon as possible to discuss this possibility.    Data Analysis Labs  Two data analysis labs utilizing Google Sheets will be assigned throughout the semester; more details will be provided later in the course. Each data lab will count as two homework assignment scores.    Exams  There will be four exams in this course, one of which will be a cumulative final exam. Tentative dates are March 4, April 1, May 6, and May 13. Make-up exams will be given at the instructor's discretion; if you miss an exam for any reason, it is your responsibility to reach out regarding a potential make-up exam.    Grade Allocation  Your course grade will be determined by the following distribution. You must get at least a 50% on the final exam in order to pass the class .    Assignment  Percentage    Homework  20%    Exam 1  20%    Exam 2  20%    Exam 3  20%    Final Exam  20%      Grading Scale  Letter grades will be assigned as follows. Grades will not be curved.    Letter Grade  Percent Needed    A  93%    A-  90%    B+  87%    B  83%    B-  80%    C+  77%    C  73%    C-  70%    D+  67%    D  63%    D-  60%    E  Below 60%       Course Policies   Email  I try to respond to emails and MyOpenMath messages within 24 hours. You are encouraged to email\/message regarding the homework; however, emails sent within 24 hours of a due date may not get a response before the deadline. So do not wait until the last minute to attempt the assignments!    Studying  To succeed in this course, you will need to do more than simply attend class. Mathematics is a subject which is learned by doing, meaning it is important to work problems outside of class to fully understand the concepts we cover. The assigned homework is the minimum amount you should be completing; if you feel like you don't fully understand a concept, ask me to guide you to some additional practice problems. A general rule for studying (in all college courses) is for each hour of class per week you spend a minimum of two hours outside of class on homework, studying, reading the text, etc. Since this course meets three hours per week, you should plan to spend at least six hours per week working on course material.    Academic Integrity and AI Usage  The WSU Mathematics Department does not tolerate academic dishonesty! For an explanation of what is considered “academic dishonesty” at WSU, please see the policy included in the 2025-2026 Undergraduate Catalog . All instructors in the WSU Mathematics Department are required to report all incidents of academic dishonesty observed, detected, or otherwise determined to have occurred to the WSU Academic Central File. WSU requires some penalty be imposed for every reported violation of the academic honesty policy. All incidents of academic dishonesty in this course will result in (at least) a score of 0 on that assignment; additional penalties will be imposed at the instructor's discretion and\/or as required by the Mathematics Department Academic Honesty Policy .    Instructor Rights   As the instructor of this course, I reserve the right to make changes to the above course policies at any time. All changes will be announced in class.      Student Learning Outcomes  Students will be able to    investigate and draw conclusions from data across many disciplines.    complete at least one data analysis lab and present a written report to effectively communicate their findings in a technical report format.   interpret and produce graphical representations of data with and without the use of technology.  interpret and produce descriptive statistics with and without the use of technology.  interpret and produce simple linear regression models. Technology may be used to calculate some of the parameters.  solve probability problems regarding equally likely events, their complements, unions and intersection.  calculate probabilities of normal random variables; and calculate percentiles of normal distributions.  produce probabilities related to the central limit theorem.  produce (by hand and using technology) and interpret confidence intervals for one and two population mean.  perform (by hand and using technology) hypothesis tests for one and two population mean.     LASC  This is a Quantitative Reasoning (QR) course in the Liberal Arts and Sciences Curriculum (LASC).  The course addresses the following LASC Quantitative Reasoning objectives:    Acquaint students with formal systems, procedures, and sequences of operations.    Strengthen students' understanding of variables and functions.    Apply mathematical techniques to the analysis and solution of real-life problems.    Emphasize the importance of accuracy, including precise language and careful definitions of mathematical concepts.    Understand both the underlying principles and practical applications of one or more fields of mathematics.    Develop an understanding of and facility with statistical analysis an analysis, including understanding of its applications and limitations.    and the following LASC overarching objectives:    Communicate effectively orally and in writing.    Understand and employ quantitative and qualitative reasoning.    Apply skills in critical thinking.    Understand the roles of science and technology in our modern world.    Become socially responsible agents in the world.    Make connections across courses and disciplines.    Develop as healthy individuals--physically, emotionally, socially, ethically, and intellectually.      Course Schedule  Here is a tentative schedule of topics to be discussed in our class meetings. We will try to stay on schedule as much as possible. If class is canceled for any reason, then the schedule will be adjusted to accommodate this cancelation. This could include a rearrangement of topics, removing a \"review\" day, or skipping a topic entirely, depending on the timing of the cancelation. Any changes to this schedule will be announced in class and via email.    Week (Mon)  Monday Topics  Wednesday Topics    1\/19  No class - MLK Day  Statistics Basics    1\/26  No class - snow  Measures of center, distributions    2\/2  Measures of spread  Five-number summary, box plots    2\/9  Empirical rule, z-scores  Probability    2\/16  No class - February Break    2\/23  Probability Rules  Conditional Probability    3\/2  Review  Exam 1    3\/9  Standard normal distribution  Normally distributed variables    3\/16  Percentiles  Mean\/SD of sampling distribution    3\/23  Prob with sampling distribution  Confidence intervals    3\/30  Review  Exam 2    4\/6  Intro to hypothesis testing  Hypothesis testing with CVs    4\/13  Hypothesis testing with p-values  Two-mean hypothesis testing    4\/20  No class - April Break    4\/27  Regression basics  Correlation    5\/4  Review  Exam 3    5\/11  Review  Final Exam     "
},
{
...
},
{
  ...
  "body": " Calculating Compound interest for more than a year  You deposit $7,500 in a savings account that has a rate of 6%. The interest is compounded monthly. How much money will you have after five years? Find the interest after five years.   To find the future value of the account, we use the compound interest formula: Given , , , and :   The interest earned over five years is:    "
},
{
...
},
{
  ...
  "body": " Calculating the Value of an Annuity   You deposit into a savings plan at the end of each year for three years. The interest rate is per year compounded annually.   Find the value of the annuity after three years.    Find the interest earned.       We use the future value formula for an annuity: where , , , and .     Substituting the values into the formula: The value of the annuity after three years is .    The total amount of deposits made is . The interest earned is the difference between the future value and the total deposits: The interest earned is .      "
},
{
  "id": "exercise-a4",
  "level": "2",
  ...
  "body": " Retirement Savings: Growth After Contributions Cease   To save for retirement, you decide to deposit into an IRA at the end of each year for the next 10 years. If you can count on an interest rate of per year compounded annually:   How much will you have from the IRA after 40 years, assuming no additional deposits or withdrawals after the 10 years of contribution?    Find the interest earned.       This problem requires two steps. First, we find the value of the annuity after the 10-year contribution period. Second, we treat that amount as a lump sum that grows for the remaining 30 years.   Step 1: Future Value of the Annuity (Years 1–10)      Step 2: Compound Interest on the Lump Sum (Years 11–40) The balance grows for more years using the formula :      After 40 years, you will have .    The total deposits were . The interest earned is .      "
},
{
  "id": "exercise-a5",
  "level": "2",
...
{
  "id": "exercises-finance-answers-16",
  "level": "2",
  "url": "sec-Identify-Formulas.html#exercises-finance-answers-16",
  "type": "Exercise",
  "number": "15",
  "title": "",
...
{
  "id": "notes-Voting-2-6-1",
  "level": "2",
  "url": "notes-Voting.html#notes-Voting-2-6-1",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
...
{
  "id": "notes-Voting-2-13-1",
  "level": "2",
  "url": "notes-Voting.html#notes-Voting-2-13-1",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
...
{
  "id": "notes-Voting-2-15-1",
  "level": "2",
  "url": "notes-Voting.html#notes-Voting-2-15-1",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
...
{
  "id": "notes-Voting-2-15-4",
  "level": "2",
  "url": "notes-Voting.html#notes-Voting-2-15-4",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
...
{
  "id": "section-apportionment-9-1",
  "level": "2",
  "url": "section-apportionment.html#section-apportionment-9-1",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
...
{
  "id": "section-apportionment-16-1",
  "level": "2",
  "url": "section-apportionment.html#section-apportionment-16-1",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
  "body": "Finding the Modified Divisor for Adam's Method: "
},
{
  "id": "ex-doctors",
  "level": "2",
